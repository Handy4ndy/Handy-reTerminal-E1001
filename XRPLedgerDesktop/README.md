...
A minimal, dedicated XRP Ledger stream monitor for ESP32-S3 with e-Ink display. This streamlined version focuses on real-time ledger monitoring with zero configuration overhead.

![Version](https://img.shields.io/badge/version-1.1-blue.svg)
![Platform](https://img.shields.io/badge/platform-ESP32--S3-green.svg)
![Network](https://img.shields.io/badge/network-XRP%20Ledger-orange.svg)
...
✅ **Real-time Stream** - Live XRP Ledger data via WebSocket  
✅ **E-Ink Optimized** - Minimal flashing with partial updates  
✅ **Static Background** - Professional XRPL branding throughout  
✅ **Transaction Visualization** - Visual representation of ledger activity  
✅ **Server Stats** - Build version, peers, latency, state, and uptime  
...
Just pure, real-time XRP Ledger monitoring with persistent high score tracking.

### Left Panel
- Server hostname (s2.ripple.com)
- Current ledger index
- Transaction count per ledger
- Visual transaction representation
- Educational link (xrpl.org)
...
- **WebSocketsClient** - WebSocket connection to XRPL
...
### 1. Clone or Download
```bash
git clone https://github.com/YourUsername/XRPLedgerDesktop.git
cd XRPLedgerDesktop
```
...
### 1. Power On
Device boots and displays XRPL background with logo.

### 2. WiFi Setup
- **Left side**: Shows XRP Ledger information
- **Right side**: Shows WiFi portal instructions

Connect to WiFi access point:
- **SSID**: `XRPLedger-Setup`
- **Portal**: `192.168.4.1`
...
1. Device creates `XRPLedger-Setup` access point
...
```
XRPLedgerDesktop/
├── XRPLedgerDesktop.ino    # Main sketch with button controls & high scores
├── xrpl800x480.h            # XRPL logo bitmap (800x480)
└── README.md                # This file
```
...
```cpp
// In setup()
webSocket.beginSSL("s2.ripple.com", 443, "/");
// Replace with your preferred XRPL node
```
...
- Check for `XRPLedger-Setup` network
...
Looking for Xahau network monitoring? Check out:
- **XahauDesktop** - Identical design for Xahau network
...
- **XRPL Foundation** - XRP Ledger protocol
- **Ripple** - s2.ripple.com public node
